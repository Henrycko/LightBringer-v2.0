...
echo Selamat datang kak, Siapa nama kamu? #tulisan keluar
...
if [[ $response != *HACKER* ]]; then
    ...
    echo
    echo "Masukan angka 1/2 yang kamu ingin pilih"
    echo " 1.Tips"
    echo " 2.Cek"
    echo "1/2?"
    read info
    if [ $info = "1" ]; then
        ...
        echo " Meskipun penjual asli, tetap waspada"
            ...
            echo
            echo "Silahkan masukan NIK Tujuan"
...
echo
echo "==================================="
echo " Penyusun  : Henrycko"
echo " Pendukung : Dzakira Alzena Daiva"
echo " Tools Milik @zLucifer"
